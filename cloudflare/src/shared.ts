export interface Env { DB:D1Database; ASSETS:Fetcher; SITE_ORIGIN:string; GOOGLE_CLIENT_ID:string; GOOGLE_CLIENT_SECRET:string; RELEASE_SHA:string; MAINTENANCE:string; AUTH_ENABLED:string; CF_VERSION_METADATA?:{id:string} }
