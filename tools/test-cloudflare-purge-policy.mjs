...
const dailyPolicy = buildPurgePolicy(['data/daily/1/2026-09.bin', 'js/daily-client.js']);
assert.ok(dailyPolicy.urls.includes('https://nodostream.com/trades/daily/'));
assert.ok(dailyPolicy.urls.includes('https://nodostream.com/map/'));
assert.ok(buildPurgePolicy(['js/daily-client.js']).urls.includes('https://nodostream.com/trades/daily/'));
assert.ok(buildPurgePolicy(['js/daily-model.js']).urls.includes('https://nodostream.com/map/'));
