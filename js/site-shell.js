(() => {
  ...
  if(['/','/map/','/trades/','/trades/daily/','/apartment/','/compare/','/ranking/','/stats/','/market/'].includes(location.pathname.replace(/index\.html$/,''))){
    ...
    const model=document.createElement('script');model.src='/js/rental-model.js?v=20260920-map-convert1';model.onload=()=>{const app=document.createElement('script');app.src='/js/rental-app.js?v=20260921-shared-detail2';document.head.append(app);};document.head.append(model);
  }
})();
