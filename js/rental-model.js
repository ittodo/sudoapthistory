(function(root){
  ...
  function match(t,s){
    ...
    if(s.district&&t.c.g!==s.district)return false;
  ...
  const api={TYPES,REGIONS,iso,decode,metric,change,annual,match,category,rateFor,range,months,normalize};root.NodoRental=api;
