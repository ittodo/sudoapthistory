'use strict';
importScripts('/js/rental-model.js?v=20260922-regions1','/js/verified-data-cache.js?v=20260921-shared1','/js/rental-map-model.js?v=20260922-regions1','/js/region-price-cache.js?v=20260922-quarter1');
...
async function prefetch(s,revision){
  ...
  for(const [path,entry]of cache)if(entry.background&&!entry.settled&&!paths.includes(path)&&!activeMapPaths.has(path)){entry.controller.abort();cache.delete(path);}
